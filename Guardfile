...
guard 'spork', :rspec_env => { 'RAILS_ENV' => 'test' } do
  watch('spec/dummy/app/config/application.rb')
  watch('spec/dummy/app/config/environment.rb')
  watch('spec/dummy/app/config/environments/test.rb')
  watch(%r{^spec/dummy/app/config/initializers/.+\.rb$})
  watch('Gemfile.lock')
...
guard :rspec, cli: "--color --drb", verion: 2 do
